...
"border-radius: 5px;")
        ...
        self.pushButton.setStyleSheet(u"background-color: rgb(0, 53, 102);\n"
"color: rgb(211, 223, 227);\n"
"border-radius: 5px;")
    ...
    def retranslateUi(self, GrounStation):
        ...
        self.pushButton.setText(QCoreApplication.translate("GrounStation", u"MQTT", None))
        ...
        self.copyright.setText(QCoreApplication.translate("GrounStation", u"Ground station for Alien sat by space AC for Thailand CanSat competition V0.7", None))
    # retranslateUi
